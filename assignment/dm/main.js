! function(e) {
	...
	(function(e) {
		...
		$(function() {
				...
				switch (e) {
					case 1:
						return {
							...
							fundtext: "Moon Fund",
							imgArr: new Array("bg1_2fb78b.jpg", "bg2.jpg", "bg3.jpg", "bg4.jpg", "bg5.jpg", "bg6.jpg", "bg7.jpg", "bg8.jpg", "bg9.jpg"),
							imgArrlvl: new Array("level1_17905a.png"),
					...
					case 2:
						return {
							...
							fundtext: "Mars Fund",
							imgArr: new Array("bg001.jpg", "bg002.jpg?2", "bg003.jpg", "bg5.jpg"),
							imgArrlvl: new Array("level2_17905a.png"),
					...
					case 3:
						return {
							...
							fundtext: "???? Fund",
							imgArr: new Array("bg101.jpg", "bg102.jpg", "bg103.jpg", "bg104.jpg", "bg105.jpg"),
							imgArrlvl: new Array("level3_179059.png"),
			...
			function R() {
				var e = "";
				Yn.currentlevel().upgrades.clickups.length > Tn.currentlevel().clickupslevel + 1 && (e += '<div id="clickupgradediv"class="ui-state-highlight ui-corner-all upgrade desc" style="margin-top: 5px; padding: 5px 5px;">', e += '<img src="empty.png" class="level' + Tn.level + " level" + Tn.level + "-clickupgrade" + Tn.currentlevel().clickupslevel + '" style="border-image: none;"align="left"/>', e += '<div style="width:410px;"><strong>' + Yn.currentlevel().upgrades.clickups[Tn.currentlevel().clickupslevel + 1].name + " - Cost: " + Ke(Yn.currentlevel().upgrades.clickups[Tn.currentlevel().clickupslevel + 1].cost) + " " + Yn.currentlevel().modifier_small + ' doge.</strong><br/><span class="desc">' + Yn.currentlevel().upgrades.clickups[Tn.currentlevel().clickupslevel + 1].desc + '</span></div><div style="position:absolute;top:20px;right:5px;"><button id="upgradeclicks">Upgrade!</button></div>', e += "</div>"), Yn.currentlevel().upgrades.shibeups.length > Tn.currentlevel().shibeupslevel + 1 && (e += '<div id="shibeupgradediv"class="ui-state-highlight ui-corner-all upgrade desc" style="margin-top: 5px; padding: 5px 5px">', e += '<img src="empty.png" class="level' + Tn.level + " level" + Tn.level + "-shibeupgrade" + Tn.currentlevel().shibeupslevel + '"  align="left" />', e += '<div style="width:410px;"><strong>' + Yn.currentlevel().upgrades.shibeups[Tn.currentlevel().shibeupslevel + 1].name + " - Cost: " + Ke(Yn.currentlevel().upgrades.shibeups[Tn.currentlevel().shibeupslevel + 1].cost) + " " + Yn.currentlevel().modifier_small + ' doge.</strong><br/><span class="desc">' + Yn.currentlevel().upgrades.shibeups[Tn.currentlevel().shibeupslevel + 1].desc + '</span></div><div style="position:absolute;top:20px;right:5px;"><button id="upgradeshibes">Upgrade!</button></div>', e += "</div>"), Yn.currentlevel().upgrades.kennelsups.length > Tn.currentlevel().kennelsupslevel + 1 && (e += '<div id="kennelsupgradediv" class="ui-state-highlight ui-corner-all upgrade desc" style="margin-top: 5px; padding: 5px 5px">', e += '<img src="empty.png" class="level' + Tn.level + " level" + Tn.level + "-kennelsupgrade" + Tn.currentlevel().kennelsupslevel + '" align="left" />', e += '<div style="width:410px;"><strong>' + Yn.currentlevel().upgrades.kennelsups[Tn.currentlevel().kennelsupslevel + 1].name + " - Cost: " + Ke(Yn.currentlevel().upgrades.kennelsups[Tn.currentlevel().kennelsupslevel + 1].cost) + " " + Yn.currentlevel().modifier_small + ' doge.</strong><br/><span class="desc">' + Yn.currentlevel().upgrades.kennelsups[Tn.currentlevel().kennelsupslevel + 1].desc + '</span></div><div style="position:absolute;top:20px;right:5px;"><button id="upgradekennels">Upgrade!</button></div>', e += "</div>"), Yn.currentlevel().upgrades.kittensups.length > Tn.currentlevel().kittensupslevel + 1 && (e += '<div id="kittensupgradediv" class="ui-state-highlight ui-corner-all upgrade desc" style="margin-top: 5px; padding: 5px 5px">', e += '<img src="empty.png" class="level' + Tn.level + " level" + Tn.level + "-kittensupgrade" + Tn.currentlevel().kittensupslevel + '" align="left" />', e += '<div style="width:410px;"><strong>' + Yn.currentlevel().upgrades.kittensups[Tn.currentlevel().kittensupslevel + 1].name + " - Cost: " + Ke(Yn.currentlevel().upgrades.kittensups[Tn.currentlevel().kittensupslevel + 1].cost) + " " + Yn.currentlevel().modifier_small + ' doge.</strong><br/><span class="desc">' + Yn.currentlevel().upgrades.kittensups[Tn.currentlevel().kittensupslevel + 1].desc + '</span></div><div style="position:absolute;top:20px;right:5px;"><button id="upgradekittens">Upgrade!</button></div>', e += "</div>"), Yn.currentlevel().upgrades.rocketups.length > Tn.currentlevel().rocketupslevel + 1 && (e += '<div id="rocketupgradediv" class="ui-state-highlight ui-corner-all upgrade desc" style="margin-top: 5px; padding: 5px 5px">', e += '<img src="empty.png" class="level' + Tn.level + " level" + Tn.level + "-rocketupgrade" + Tn.currentlevel().rocketupslevel + '" align="left" />', e += '<div style="width:410px;"><strong>' + Yn.currentlevel().upgrades.rocketups[Tn.currentlevel().rocketupslevel + 1].name + " - Cost: " + Ke(Yn.currentlevel().upgrades.rocketups[Tn.currentlevel().rocketupslevel + 1].cost) + " " + Yn.currentlevel().modifier_small + ' doge.</strong><br/><span class="desc">' + Yn.currentlevel().upgrades.rocketups[Tn.currentlevel().rocketupslevel + 1].desc + '</span></div><div style="position:absolute;top:20px;right:5px;"><button id="upgraderockets">Upgrade!</button></div>', e += "</div>"), Yn.currentlevel().upgrades.baseups.length > Tn.currentlevel().baseupslevel + 1 && (e += '<div id="baseupgradediv" class="ui-state-highlight ui-corner-all upgrade desc" style="margin-top: 5px; padding: 5px 5px">', e += '<img src="empty.png" class="level' + Tn.level + " level" + Tn.level + "-baseupgrade" + Tn.currentlevel().baseupslevel + '" align="left" />', e += '<div style="width:410px;"><strong>' + Yn.currentlevel().upgrades.baseups[Tn.currentlevel().baseupslevel + 1].name + " - Cost: " + Ke(Yn.currentlevel().upgrades.baseups[Tn.currentlevel().baseupslevel + 1].cost) + " " + Yn.currentlevel().modifier_small + ' doge.</strong><br/><span class="desc">' + Yn.currentlevel().upgrades.baseups[Tn.currentlevel().baseupslevel + 1].desc + '</span></div><div style="position:absolute;top:20px;right:5px;"><button id="upgradebases">Upgrade!</button></div>', e += "</div>"), Yn.currentlevel().upgrades.rigups.length > Tn.currentlevel().rigupslevel + 1 && (e += '<div id="rigupgradediv" class="ui-state-highlight ui-corner-all upgrade desc" style="margin-top: 5px; padding: 5px 5px">', e += '<img src="empty.png" class="level' + Tn.level + " level" + Tn.level + "-rigupgrade" + Tn.currentlevel().rigupslevel + '" align="left" />', e += '<div style="width:410px;"><strong>' + Yn.currentlevel().upgrades.rigups[Tn.currentlevel().rigupslevel + 1].name + " - Cost: " + Ke(Yn.currentlevel().upgrades.rigups[Tn.currentlevel().rigupslevel + 1].cost) + " " + Yn.currentlevel().modifier_small + ' doge.</strong><br/><span class="desc">' + Yn.currentlevel().upgrades.rigups[Tn.currentlevel().rigupslevel + 1].desc + '</span></div><div style="position:absolute;top:20px;right:5px;"><button id="upgraderigs">Upgrade!</button></div>', e += "</div>"), Yn.currentlevel().upgrades.extraups.length > Tn.currentlevel().extraupslevel && (e += '<div id="extraupgradediv" class="ui-state-highlight ui-corner-all upgrade desc" style="margin-top: 5px; padding: 5px 5px">', e += '<img src="empty.png" class="level' + Tn.level + " level" + Tn.level + "-extraupgrade" + Tn.currentlevel().extraupslevel + '" align="left" />', e += '<div style="width:410px;"><strong>' + Yn.currentlevel().upgrades.extraups[Tn.currentlevel().extraupslevel].name + " - Cost: " + Ke(Yn.currentlevel().upgrades.extraups[Tn.currentlevel().extraupslevel].cost) + " " + Yn.currentlevel().modifier_small + ' doge.</strong><br/><span class="desc">' + Yn.currentlevel().upgrades.extraups[Tn.currentlevel().extraupslevel].desc + '</span></div><div style="position:absolute;top:20px;right:5px;"><button id="upgradeextras">Upgrade!</button></div>', e += "</div>"), $("#upgradewrapper").html(e), $("#upgradeclicks").button({
					icons: {
			...
			function Kt() {
				new Wt(1, "The First 1K", "Get 1,000 dogecoins.", "placeholder.png", new Ut(1, "coins", 1e3)), new Wt(2, "It's Over Nine Thousand!", "Get over 9,000 dogecoins.", "placeholder.png", new Ut(1, "coins", 9001)), new Wt(3, "One Hundred Thousand Dogecoins", "Get 100,000 dogecoins.", "placeholder.png", new Ut(1, "coins", 1e5)), new Wt(293932, "Dogeillionaire", "Get 1,000,000 dogecoins.", "placeholder.png", new Ut(1, "coins", 1e6)), new Wt(4, "Money-Maker!", "Get 50,000,000 dogecoins.", "placeholder.png", new Ut(1, "coins", 5e6)), new Wt(5, "Cash Cow? More Like Cash Doge!", "Get 100,000,000 dogecoins.", "placeholder.png", new Ut(1, "coins", 1e8)), new Wt(6, "Slumdogeillionaire", "Get 500,000,000 dogecoins.", "placeholder.png", new Ut(1, "coins", 5e8)), new Wt(7, "One Billion Dogecoins", "Get 1,000,000,000 dogecoins.", "placeholder.png", new Ut(1, "coins", 1e9)), new Wt(8, "Fifty Billion Dogecoins", "Get 50,000,000,000 dogecoins.", "placeholder.png", new Ut(1, "coins", 5e10)), new Wt(9, "One Hundred Billion Dogecoins", "Get 100,000,000,000 dogecoins.", "placeholder.png", new Ut(1, "coins", 1e11)), new Wt(10, "One Trillion Dogecoins", "Get 1,000,000,000,000 dogecoins.", "placeholder.png", new Ut(1, "coins", 1e12)), new Wt(11, "One Quadrillion Dogecoins", "Get 1,000,000,000,000,000 dogecoins.", "placeholder.png", new Ut(1, "coins", 1e15)), new Wt(12, "One Quintillion Dogecoins", "Get 1,000,000,000,000,000,000 dogecoins. I'm not even mad, that's amazing.", "placeholder.png", new Ut(1, "coins", 1e18)), new Wt(13, "One Sextillion Dogecoins", "Get 1,000,000,000,000,000,000,000 dogecoins. Is such a thing even possible?", "placeholder.png", new Ut(1, "coins", 1e21)), new Wt(14, "One Septillion Dogecoins", "Get 1,000,000,000,000,000,000,000,000 dogecoins. I think someone is cheating.", "placeholder.png", new Ut(1, "coins", 1e24)), new Wt(100, "It's a party!", "Get 10 Mining Shibes.", "placeholder.png", new Ut(1, "shibes", 10)), new Wt(101, "Fifty Mining Shibes", "Get 50 Mining Shibes.", "placeholder.png", new Ut(1, "shibes", 50)), new Wt(102, "One Hundred Mining Shibes", "Get 100 Mining Shibes.", "placeholder.png", new Ut(1, "shibes", 100)), new Wt(103, "Five Hundred Mining Shibes", "Get 500 Mining Shibes.", "placeholder.png", new Ut(1, "shibes", 500)), new Wt(104, "One Thousand Mining Shibes", "Get 1,000 Mining Shibes.", "placeholder.png", new Ut(1, "shibes", 1e3)), new Wt(105, "1337-Krew", "Get 1,337 Mining Shibes.", "placeholder.png", new Ut(1, "shibes", 1337)), new Wt(106, "5,000 Mining Shibes", "Get 5,000 Mining Shibes.", "placeholder.png", new Ut(1, "shibes", 5e3)), new Wt(107, "10,000 Mining Shibes", "Get 10,000 Mining Shibes.", "placeholder.png", new Ut(1, "shibes", 1e4)), new Wt(200, "Woof Woof", "Get 10 Doge Kennels.", "placeholder.png", new Ut(1, "kennels", 10)), new Wt(201, "Fifty Doge Kennels", "Get 50 Doge Kennels.", "placeholder.png", new Ut(1, "kennels", 50)), new Wt(202, "One Hundred Doge Kennels", "Get 100 Doge Kennels.", "placeholder.png", new Ut(1, "kennels", 100)), new Wt(203, "Five Hundred Doge Kennels", "Get 500 Doge Kennels.", "placeholder.png", new Ut(1, "kennels", 500)), new Wt(204, "One Thousand Doge Kennels", "Get 1000 Doge Kennels.", "placeholder.png", new Ut(1, "kennels", 1e3)), new Wt(205, "1337-Krew #2", "Get 1337 Doge Kennels.", "placeholder.png", new Ut(1, "kennels", 1337)), new Wt(206, "5,000 Doge Kennels", "Get 5,000 Doge Kennels.", "placeholder.png", new Ut(1, "kennels", 5e3)), new Wt(207, "10,000 Doge Kennels", "Get 10,000 Doge Kennels.", "placeholder.png", new Ut(1, "kennels", 1e4)), new Wt(300, "Mjau", "Get 10 Slave Kittens.", "placeholder.png", new Ut(1, "kittens", 10)), new Wt(301, "Fifty Slave Kittens", "Get 50 Slave Kittens.", "placeholder.png", new Ut(1, "kittens", 50)), new Wt(302, "One Hundred Slave Kittens", "Get 100 Slave Kittens.", "placeholder.png", new Ut(1, "kittens", 100)), new Wt(303, "Five Hundred Slave Kittens", "Get 500 Slave Kittens.", "placeholder.png", new Ut(1, "kittens", 500)), new Wt(304, "One Thousand Slave Kittens", "Get 1000 Slave Kittens.", "placeholder.png", new Ut(1, "kittens", 1e3)), new Wt(305, "1337-Krew #3", "Get 1337 Slave Kittens.", "placeholder.png", new Ut(1, "kittens", 1337)), new Wt(306, "5,000 Slave Kittens", "Get 5,000 Slave Kittens.", "placeholder.png", new Ut(1, "kittens", 5e3)), new Wt(307, "10,000 Slave Kittens", "Get 10,000 Slave Kittens.", "placeholder.png", new Ut(1, "kittens", 1e4)), new Wt(399, "First Doge In Space", "Get a Space Rocket.", "placeholder.png", new Ut(1, "rockets", 1)), new Wt(400, "Space, The Final Frontier", "Get 10 Space Rockets.", "placeholder.png", new Ut(1, "rockets", 10)), new Wt(401, "Fifty Space Rockets", "Get 50 Space Rockets.", "placeholder.png", new Ut(1, "rockets", 50)), new Wt(402, "One Hundred Space Rockets", "Get 100 Space Rockets.", "placeholder.png", new Ut(1, "rockets", 100)), new Wt(403, "Five Hundred Space Rockets", "Get 500 Space Rockets.", "placeholder.png", new Ut(1, "rockets", 500)), new Wt(404, "One Thousand Space Rockets", "Get 1000 Space Rockets.", "placeholder.png", new Ut(1, "rockets", 1e3)), new Wt(405, "1337-Krew #4", "Get 1337 Space Rockets.", "placeholder.png", new Ut(1, "rockets", 1337)), new Wt(406, "5,000 Space Rockets", "Get 5,000 Space Rockets.", "placeholder.png", new Ut(1, "rockets", 5e3)), new Wt(407, "10,000 Space Rockets", "Get 10,000 Space Rockets.", "placeholder.png", new Ut(1, "rockets", 1e4)), new Wt(500, "Moon Miner", "Get 10 Moon Bases.", "placeholder.png", new Ut(1, "bases", 10)), new Wt(501, "Fifty Moon Bases", "Get 50 Moon Bases.", "placeholder.png", new Ut(1, "bases", 50)), new Wt(502, "One Hundred Moon Bases", "Get 100 Moon Bases.", "placeholder.png", new Ut(1, "bases", 100)), new Wt(503, "Five Hundred Moon Bases", "Get 500 Moon Bases.", "placeholder.png", new Ut(1, "bases", 500)), new Wt(504, "One Thousand Moon Bases", "Get 1000 Moon Bases.", "placeholder.png", new Ut(1, "bases", 1e3)), new Wt(505, "1337-Krew #5", "Get 1337 Moon Bases.", "placeholder.png", new Ut(1, "bases", 1337)), new Wt(506, "5,000 Moon Bases", "Get 5,000 Moon Bases.", "placeholder.png", new Ut(1, "bases", 5e3)), new Wt(507, "10,000 Moon Bases", "Get 10,000 Moon Bases.", "placeholder.png", new Ut(1, "bases", 1e4)), new Wt(600, "Time Traveller", "Get 10 Time Machines.", "placeholder.png", new Ut(1, "rigs", 10)), new Wt(601, "Fifty Time Machines", "Get 50 Time Machines.", "placeholder.png", new Ut(1, "rigs", 50)), new Wt(602, "One Hundred Time Machines", "Get 100 Time Machines.", "placeholder.png", new Ut(1, "rigs", 100)), new Wt(603, "Five Hundred Time Machines", "Get 500 Time Machines.", "placeholder.png", new Ut(1, "rigs", 500)), new Wt(604, "One Thousand Time Machines", "Get 1000 Time Machines.", "placeholder.png", new Ut(1, "rigs", 1e3)), new Wt(605, "1337-Krew #6", "Get 1337 Time Machines.", "placeholder.png", new Ut(1, "rigs", 1337)), new Wt(606, "5,000 Time Machines", "Get 5,000 Time Machines.", "placeholder.png", new Ut(1, "rigs", 5e3)), new Wt(607, "10,000 Time Machines", "Get 10,000 Time Machines.", "placeholder.png", new Ut(1, "rigs", 1e4)), new Wt(700, "My First Upgrade", "Purchase an upgrade.", "placeholder.png", new Ut(1, "anyups", 0)), new Wt(701, "Mining Enthusiast", "Get all pickaxe upgrades.", "placeholder.png", new Ut(1, "clickups", Yn.currentlevel().upgrades.clickups.length)), new Wt(702, "Gotta Upgrade 'Em All", "Get every upgrade.", "placeholder.png", new Ut(1, "allups", 0)), new Wt(703, "My Dogecoins Brings All The Shibes To The Yard", "Get all Mining Shibe upgrades.", "placeholder.png", new Ut(1, "shibeups", Yn.currentlevel().upgrades.shibeups.length)), new Wt(704, "Maximum Efficiency Kennels", "Get all Doge Kennels upgrades.", "placeholder.png", new Ut(1, "kennelsups", Yn.currentlevel().upgrades.kennelsups.length)), new Wt(705, "Kittens Are Also Good At Something", "Get all Slave Kittens upgrades.", "placeholder.png", new Ut(1, "kittensups", Yn.currentlevel().upgrades.kittensups.length)), new Wt(706, "Maximum Warp", "Get all Space Rocket upgrades.", "placeholder.png", new Ut(1, "rocketups", Yn.currentlevel().upgrades.rocketups.length)), new Wt(707, "Space Man", "Get all Moon Base upgrades.", "placeholder.png", new Ut(1, "baseups", Yn.currentlevel().upgrades.baseups.length)), new Wt(708, "What Year Is It?", "Get all Time Machine Mining Rig upgrades.", "placeholder.png", new Ut(1, "rigups", Yn.currentlevel().upgrades.rigups.length)), new Wt(709, "Well That Was Expensive", "Get all % increase upgrades.", "placeholder.png", new Ut(1, "extraups", Yn.currentlevel().upgrades.extraups.length)), new Wt(800, "Bonus Time", "Grabbed a golden dogecoin for bonus income.", "placeholder.png", new Ut(0, "bonuscoins", 1)), new Wt(801, "Much Bonus", "Grab 5 golden dogecoins for bonus income.", "placeholder.png", new Ut(0, "bonuscoins", 5)), new Wt(802, "Bonustravaganza", "Grab 10 golden dogecoins for bonus income.", "placeholder.png", new Ut(0, "bonuscoins", 10)), new Wt(803, "I Got Luck, Persistence Or Both", "Grab 25 golden dogecoins for bonus income.", "placeholder.png", new Ut(0, "bonuscoins", 25)), new Wt(804, "I Love You", "Grab 50 golden dogecoins for bonus income.", "placeholder.png", new Ut(0, "bonuscoins", 50)), new Wt(805, "My Time Played Must Be Really High", "Grab 100 golden dogecoins for bonus income.", "placeholder.png", new Ut(0, "bonuscoins", 100)), new Wt(900, "Time Flies By", "Play for an hour.", "placeholder.png", new Ut(0, "time", 3600)), new Wt(901, "I Hope You Took Breaks", "Play for five hours.", "placeholder.png", new Ut(0, "time", 18e3)), new Wt(902, "Why Am I Still Playing", "Play for 24 hours.", "placeholder.png", new Ut(0, "time", 86400)), new Wt(903, "24/7", "Play for 7 days.", "placeholder.png", new Ut(0, "time", 604800)), new Wt(904, "I'm Awesome", "Play for two weeks.", "placeholder.png", new Ut(0, "time", 1209600)), new Wt(905, "I'm Crazy", "Play for a month.", "placeholder.png", new Ut(0, "time", 2592e3)), new Wt(906, "I Don't Have A Life", "Play for six months.", "placeholder.png", new Ut(0, "time", 15552e3)), new Wt(907, "The Insane", "Play for a year. You are special.", "placeholder.png", new Ut(0, "time", 31104e3)), new Wt(1e3, "Click Click Boom", "Click a thousand times.", "placeholder.png", new Ut(0, "clicks", 1e3)), new Wt(1001, "Really Good At Clicking", "Click 10,000 times.", "placeholder.png", new Ut(0, "clicks", 1e4)), new Wt(1002, "I've Seen Things You People Wouldn't Believe", "Click 100,000 times.", "placeholder.png", new Ut(0, "clicks", 1e5)), new Wt(1003, "A Million Clicks Baby", "Click 1,000,000 times.", "placeholder.png", new Ut(0, "clicks", 1e6)), new Wt(1004, "Ten Million Clicks", "Click 10,000,000 times.", "placeholder.png", new Ut(0, "clicks", 1e7)), new Wt(1005, "One Hundred Million Clicks", "Click 100,000,000 times.", "placeholder.png", new Ut(0, "clicks", 1e8)), new Wt(2001, "Next Level Gaming", "Gone to the moon.", "placeholder.png", new Ut(2, "level", 0)), new Wt(2100, "Lets Get It Started", "Get 10 Moon Shibes.", "placeholder.png", new Ut(2, "shibes", 10)), new Wt(2101, "Fifty Moon Shibes", "Get 50 Moon Shibes.", "placeholder.png", new Ut(2, "shibes", 50)), new Wt(2102, "One Hundred Moon Shibes", "Get 100 Moon Shibes.", "placeholder.png", new Ut(2, "shibes", 100)), new Wt(2103, "Five Hundred Moon Shibes", "Get 500 Moon Shibes.", "placeholder.png", new Ut(2, "shibes", 500)), new Wt(2104, "One Thousand Moon Shibes", "Get 1,000 Moon Shibes.", "placeholder.png", new Ut(2, "shibes", 1e3)), new Wt(2105, "1337-MoonKrew", "Get 1,337 Moon Shibes.", "placeholder.png", new Ut(2, "shibes", 1337)), new Wt(2106, "5,000 Moon Shibes", "Get 5,000 Moon Shibes.", "placeholder.png", new Ut(2, "shibes", 5e3)), new Wt(2107, "10,000 Moon Shibes", "Get 10,000 Moon Shibes.", "placeholder.png", new Ut(2, "shibes", 1e4)), new Wt(2200, "Vroom Vroom", "Get 10 Doge Cars.", "placeholder.png", new Ut(2, "kennels", 10)), new Wt(2201, "Fifty Doge Cars", "Get 50 Doge Cars.", "placeholder.png", new Ut(2, "kennels", 50)), new Wt(2202, "One Hundred Doge Cars", "Get 100 Doge Cars.", "placeholder.png", new Ut(2, "kennels", 100)), new Wt(2203, "Five Hundred Doge Cars", "Get 500 Doge Cars.", "placeholder.png", new Ut(2, "kennels", 500)), new Wt(2204, "One Thousand Doge Cars", "Get 1000 Doge Cars.", "placeholder.png", new Ut(2, "kennels", 1e3)), new Wt(2205, "1337-MoonKrew #2", "Get 1337 Doge Cars.", "placeholder.png", new Ut(2, "kennels", 1337)), new Wt(2206, "5,000 Doge Cars", "Get 5,000 Doge Cars.", "placeholder.png", new Ut(2, "kennels", 5e3)), new Wt(2207, "10,000 Doge Cars", "Get 10,000 Doge Cars.", "placeholder.png", new Ut(2, "kennels", 1e4)), new Wt(2300, "Mjau", "Get 10 Suit Shibes.", "placeholder.png", new Ut(2, "kittens", 10)), new Wt(2301, "Fifty Suit Shibes", "Get 50 Suit Shibes.", "placeholder.png", new Ut(2, "kittens", 50)), new Wt(2302, "One Hundred Suit Shibes", "Get 100 Suit Shibes.", "placeholder.png", new Ut(2, "kittens", 100)), new Wt(2303, "Five Hundred Suit Shibes", "Get 500 Suit Shibes.", "placeholder.png", new Ut(2, "kittens", 500)), new Wt(2304, "One Thousand Suit Shibes", "Get 1000 Suit Shibes.", "placeholder.png", new Ut(2, "kittens", 1e3)), new Wt(2305, "1337-MoonKrew #3", "Get 1337 Suit Shibes.", "placeholder.png", new Ut(2, "kittens", 1337)), new Wt(2306, "5,000 Suit Shibes", "Get 5,000 Suit Shibes.", "placeholder.png", new Ut(2, "kittens", 5e3)), new Wt(2307, "10,000 Suit Shibes", "Get 10,000 Suit Shibes.", "placeholder.png", new Ut(2, "kittens", 1e4)), new Wt(2399, "Exploratory Doge", "Get a Lander Shibe.", "placeholder.png", new Ut(2, "rockets", 1)), new Wt(2400, "Landing To Victory", "Get 10 Lander Shibes.", "placeholder.png", new Ut(2, "rockets", 10)), new Wt(2401, "Fifty Lander Shibes", "Get 50 Lander Shibes.", "placeholder.png", new Ut(2, "rockets", 50)), new Wt(2402, "One Hundred Lander Shibes", "Get 100 Lander Shibes.", "placeholder.png", new Ut(2, "rockets", 100)), new Wt(2403, "Five Hundred Lander Shibes", "Get 500 Lander Shibes.", "placeholder.png", new Ut(2, "rockets", 500)), new Wt(2404, "One Thousand Lander Shibes", "Get 1000 Lander Shibes.", "placeholder.png", new Ut(2, "rockets", 1e3)), new Wt(2405, "1337-MoonKrew #4", "Get 1337 Lander Shibes.", "placeholder.png", new Ut(2, "rockets", 1337)), new Wt(2406, "5,000 Lander Shibes", "Get 5,000 Lander Shibes.", "placeholder.png", new Ut(2, "rockets", 5e3)), new Wt(2407, "10,000 Lander Shibes", "Get 10,000 Lander Shibes.", "placeholder.png", new Ut(2, "rockets", 1e4)), new Wt(2500, "Mars Miner", "Get 10 Mars Bases.", "placeholder.png", new Ut(2, "bases", 10)), new Wt(2501, "Fifty Mars Bases", "Get 50 Mars Bases.", "placeholder.png", new Ut(2, "bases", 50)), new Wt(2502, "One Hundred Mars Bases", "Get 100 Mars Bases.", "placeholder.png", new Ut(2, "bases", 100)), new Wt(2503, "Five Hundred Mars Bases", "Get 500 Mars Bases.", "placeholder.png", new Ut(2, "bases", 500)), new Wt(2504, "One Thousand Mars Bases", "Get 1000 Mars Bases.", "placeholder.png", new Ut(2, "bases", 1e3)), new Wt(2505, "1337-MoonKrew #5", "Get 1337 Mars Bases.", "placeholder.png", new Ut(2, "bases", 1337)), new Wt(2506, "5,000 Mars Bases", "Get 5,000 Mars Bases.", "placeholder.png", new Ut(2, "bases", 5e3)), new Wt(2507, "10,000 Mars Bases", "Get 10,000 Mars Bases.", "placeholder.png", new Ut(2, "bases", 1e4)), new Wt(2600, "Universe Traveller", "Get 10 Infinite Dogebility Drives.", "placeholder.png", new Ut(2, "rigs", 10)), new Wt(2601, "Fifty Infinite Dogebility Drives", "Get 50 Infinite Dogebility Drives.", "placeholder.png", new Ut(2, "rigs", 50)), new Wt(2602, "One Hundred Infinite Dogebility Drives", "Get 100 Infinite Dogebility Drives.", "placeholder.png", new Ut(2, "rigs", 100)), new Wt(2603, "Five Hundred Infinite Dogebility Drives", "Get 500 Infinite Dogebility Drives.", "placeholder.png", new Ut(2, "rigs", 500)), new Wt(2604, "One Thousand Infinite Dogebility Drives", "Get 1000 Infinite Dogebility Drives.", "placeholder.png", new Ut(2, "rigs", 1e3)), new Wt(2605, "1337-MoonKrew #6", "Get 1337 Infinite Dogebility Drives.", "placeholder.png", new Ut(2, "rigs", 1337)), new Wt(2606, "5,000 Infinite Dogebility Drives", "Get 5,000 Infinite Dogebility Drives.", "placeholder.png", new Ut(2, "rigs", 5e3)), new Wt(2607, "10,000 Infinite Dogebility Drives", "Get 10,000 Infinite Dogebility Drives.", "placeholder.png", new Ut(2, "rigs", 1e4)), new Wt(2700, "My First Upgrade On The Moon", "Purchase an upgrade on the Moon.", "placeholder.png", new Ut(2, "anyups", 0)), new Wt(2701, "Mining Extraordinaire", "Get all pickaxe upgrades on the Moon.", "placeholder.png", new Ut(2, "clickups", Yn.currentlevel().upgrades.clickups.length)), new Wt(2702, "I Think We're Done Here", "Get every upgrade on the Moon.", "placeholder.png", new Ut(2, "allups", 0)), new Wt(2703, "Moon Shibes... ASSEMBLE!", "Get all Moon Shibe upgrades.", "placeholder.png", new Ut(2, "shibeups", Yn.currentlevel().upgrades.shibeups.length)), new Wt(2704, "Vroom Vroom Mtrfkr", "Get all Doge Car upgrades.", "placeholder.png", new Ut(2, "kennelsups", Yn.currentlevel().upgrades.kennelsups.length)), new Wt(2705, "A suite, a shower, a shave... and the feel of a suit", "Get all Suit Shibes upgrades.", "placeholder.png", new Ut(2, "kittensups", Yn.currentlevel().upgrades.kittensups.length)), new Wt(2706, "Lander Flander", "Get all Lander Shibe upgrades.", "placeholder.png", new Ut(2, "rocketups", Yn.currentlevel().upgrades.rocketups.length)), new Wt(2707, "Mars Man", "Get all Mars Base upgrades.", "placeholder.png", new Ut(2, "baseups", Yn.currentlevel().upgrades.baseups.length)), new Wt(2708, "What Universe Is It?", "Get all Infinite Dogebility Drive upgrades.", "placeholder.png", new Ut(2, "rigups", Yn.currentlevel().upgrades.rigups.length)), new Wt(2709, "Max Percent", "Get all % increase upgrades.", "placeholder.png", new Ut(2, "extraups", Yn.currentlevel().upgrades.extraups.length)), new Wt(3001, "What Took Me So Long", "Gone to Mars.", "placeholder.png", new Ut(3, "level", 0)), new Wt(3100, "It's a rave!", "Get 10 Party Shibes.", "placeholder.png", new Ut(3, "shibes", 10)), new Wt(3101, "Fifty Party Shibes", "Get 50 Party Shibes.", "placeholder.png", new Ut(3, "shibes", 50)), new Wt(3102, "One Hundred Party Shibes", "Get 100 Party Shibes.", "placeholder.png", new Ut(3, "shibes", 100)), new Wt(3103, "Five Hundred Party Shibes", "Get 500 Party Shibes.", "placeholder.png", new Ut(3, "shibes", 500)), new Wt(3104, "One Thousand Party Shibes", "Get 1,000 Party Shibes.", "placeholder.png", new Ut(3, "shibes", 1e3)), new Wt(3105, "1337-MarsKrew", "Get 1,337 Party Shibes.", "placeholder.png", new Ut(3, "shibes", 1337)), new Wt(3106, "5,000 Party Shibes", "Get 5,000 Party Shibes.", "placeholder.png", new Ut(3, "shibes", 5e3)), new Wt(3107, "10,000 Party Shibes", "Get 10,000 Party Shibes.", "placeholder.png", new Ut(3, "shibes", 1e4)), new Wt(3200, "Such Curious", "Get 10 CuriosiDoges.", "placeholder.png", new Ut(3, "kennels", 10)), new Wt(3201, "Fifty CuriosiDoges", "Get 50 CuriosiDoges.", "placeholder.png", new Ut(3, "kennels", 50)), new Wt(3202, "One Hundred CuriosiDoges", "Get 100 CuriosiDoges.", "placeholder.png", new Ut(3, "kennels", 100)), new Wt(3203, "Five Hundred CuriosiDoges", "Get 500 CuriosiDoges.", "placeholder.png", new Ut(3, "kennels", 500)), new Wt(3204, "One Thousand CuriosiDoges", "Get 1000 CuriosiDoges.", "placeholder.png", new Ut(3, "kennels", 1e3)), new Wt(3205, "1337-MarsKrew #2", "Get 1337 CuriosiDoges.", "placeholder.png", new Ut(3, "kennels", 1337)), new Wt(3206, "5,000 CuriosiDoges", "Get 5,000 CuriosiDoges.", "placeholder.png", new Ut(3, "kennels", 5e3)), new Wt(3207, "10,000 CuriosiDoges", "Get 10,000 CuriosiDoges.", "placeholder.png", new Ut(3, "kennels", 1e4)), new Wt(3300, "Mjau", "Get 10 DJ Kittenz.", "placeholder.png", new Ut(3, "kittens", 10)), new Wt(3301, "Fifty DJ Kittenz", "Get 50 DJ Kittenz.", "placeholder.png", new Ut(3, "kittens", 50)), new Wt(3302, "One Hundred DJ Kittenz", "Get 100 DJ Kittenz.", "placeholder.png", new Ut(3, "kittens", 100)), new Wt(3303, "Five Hundred DJ Kittenz", "Get 500 DJ Kittenz.", "placeholder.png", new Ut(3, "kittens", 500)), new Wt(3304, "One Thousand DJ Kittenz", "Get 1000 DJ Kittenz.", "placeholder.png", new Ut(3, "kittens", 1e3)), new Wt(3305, "1337-MarsKrew #3", "Get 1337 DJ Kittenz.", "placeholder.png", new Ut(3, "kittens", 1337)), new Wt(3306, "5,000 DJ Kittenz", "Get 5,000 DJ Kittenz.", "placeholder.png", new Ut(3, "kittens", 5e3)), new Wt(3307, "10,000 DJ Kittenz", "Get 10,000 DJ Kittenz.", "placeholder.png", new Ut(3, "kittens", 1e4)), new Wt(3399, "Space Funk Activated", "Get a Space Bass.", "placeholder.png", new Ut(3, "rockets", 1)), new Wt(3400, "Music Will Save Us", "Get 10 Space Bass.", "placeholder.png", new Ut(3, "rockets", 10)), new Wt(3401, "Fifty Space Bass", "Get 50 Space Bass.", "placeholder.png", new Ut(3, "rockets", 50)), new Wt(3402, "One Hundred Space Bass", "Get 100 Space Bass.", "placeholder.png", new Ut(3, "rockets", 100)), new Wt(3403, "Five Hundred Space Bass", "Get 500 Space Bass.", "placeholder.png", new Ut(3, "rockets", 500)), new Wt(3404, "One Thousand Space Bass", "Get 1000 Space Bass.", "placeholder.png", new Ut(3, "rockets", 1e3)), new Wt(3405, "1337-MarsKrew #4", "Get 1337 Space Bass.", "placeholder.png", new Ut(3, "rockets", 1337)), new Wt(3406, "5,000 Space Bass", "Get 5,000 Space Bass.", "placeholder.png", new Ut(3, "rockets", 5e3)), new Wt(3407, "10,000 Space Bass", "Get 10,000 Space Bass.", "placeholder.png", new Ut(3, "rockets", 1e4)), new Wt(3500, "Meta Miner", "Get 10 Meta Shibes.", "placeholder.png", new Ut(3, "bases", 10)), new Wt(3501, "Fifty Meta Shibes", "Get 50 Meta Shibes.", "placeholder.png", new Ut(3, "bases", 50)), new Wt(3502, "One Hundred Meta Shibes", "Get 100 Meta Shibes.", "placeholder.png", new Ut(3, "bases", 100)), new Wt(3503, "Five Hundred Meta Shibes", "Get 500 Meta Shibes.", "placeholder.png", new Ut(3, "bases", 500)), new Wt(3504, "One Thousand Meta Shibes", "Get 1000 Meta Shibes.", "placeholder.png", new Ut(3, "bases", 1e3)), new Wt(3505, "1337-MarsKrew #5", "Get 1337 Meta Shibes.", "placeholder.png", new Ut(3, "bases", 1337)), new Wt(3506, "5,000 Meta Shibes", "Get 5,000 Meta Shibes.", "placeholder.png", new Ut(3, "bases", 5e3)), new Wt(3507, "10,000 Meta Shibes", "Get 10,000 Meta Shibes.", "placeholder.png", new Ut(3, "bases", 1e4)), new Wt(3600, "Life Found A Way", "Get 10 Time Travel T-Rexes.", "placeholder.png", new Ut(3, "rigs", 10)), new Wt(3601, "Fifty Time Travel T-Rexes", "Get 50 Time Travel T-Rexes.", "placeholder.png", new Ut(3, "rigs", 50)), new Wt(3602, "One Hundred Time Travel T-Rexes", "Get 100 Time Travel T-Rexes.", "placeholder.png", new Ut(3, "rigs", 100)), new Wt(3603, "Five Hundred Time Travel T-Rexes", "Get 500 Time Travel T-Rexes.", "placeholder.png", new Ut(3, "rigs", 500)), new Wt(3604, "One Thousand Time Travel T-Rexes", "Get 1000 Time Travel T-Rexes.", "placeholder.png", new Ut(3, "rigs", 1e3)), new Wt(3605, "1337-MarsKrew #6", "Get 1337 Time Travel T-Rexes.", "placeholder.png", new Ut(3, "rigs", 1337)), new Wt(3606, "5,000 Time Travel T-Rexes", "Get 5,000 Time Travel T-Rexes.", "placeholder.png", new Ut(3, "rigs", 5e3)), new Wt(3607, "10,000 Time Travel T-Rexes", "Get 10,000 Time Travel T-Rexes.", "placeholder.png", new Ut(3, "rigs", 1e4)), new Wt(3700, "Mars Has Upgrades For Me", "Purchase an upgrade on Mars.", "placeholder.png", new Ut(3, "anyups", 0)), new Wt(3701, "Phenomenal Mining", "Get all pickaxe upgrades on Mars.", "placeholder.png", new Ut(3, "clickups", Yn.currentlevel().upgrades.clickups.length)), new Wt(3702, "Rare Feat", "Get every upgrade on Mars.", "placeholder.png", new Ut(3, "allups", 0)), new Wt(3703, "Party On Dude", "Get all Party Shibe upgrades.", "placeholder.png", new Ut(3, "shibeups", Yn.currentlevel().upgrades.shibeups.length)), new Wt(3704, "Curiosity", "Get all CuriosiDoges upgrades.", "placeholder.png", new Ut(3, "kennelsups", Yn.currentlevel().upgrades.kennelsups.length)), new Wt(3705, "Chika Chika Wa Wa", "Get all DJ Kittenz upgrades.", "placeholder.png", new Ut(3, "kittensups", Yn.currentlevel().upgrades.kittensups.length)), new Wt(3706, "The Bass Is Strong With This One", "Get all Space Bass upgrades.", "placeholder.png", new Ut(3, "rocketups", Yn.currentlevel().upgrades.rocketups.length)), new Wt(3707, "Meta Man", "Get all Meta Shibe upgrades.", "placeholder.png", new Ut(3, "baseups", Yn.currentlevel().upgrades.baseups.length)), new Wt(3708, "Welcome... to Jurassic Bark.", "Get all Time Travel T-Rex upgrades.", "placeholder.png", new Ut(3, "rigups", Yn.currentlevel().upgrades.rigups.length)), new Wt(3709, "I'm Giving Her All She's Got Captain", "Get all % increase upgrades.", "placeholder.png", new Ut(3, "extraups", Yn.currentlevel().upgrades.extraups.length))
			}
			...
			function Xt() {
				soundManager.createSound({
					id: "coinappear",
					url: "Goldencoin_appear.mp3",
					autoLoad: !0,
					autoPlay: !1,
					onload: function() {}
				}), soundManager.createSound({
					id: "coinloop",
					url: "Goldencoin_loop_optimized.mp3",
					autoLoad: !0,
					autoPlay: !1,
					onload: function() {}
				}), soundManager.createSound({
					id: "cointaken",
					url: "Goldencoin_taken.mp3",
					autoLoad: !0,
					autoPlay: !1
				}), soundManager.createSound({
					id: "achievementunlocked",
					url: "Achievement_unlocked.mp3",
					autoLoad: !0,
					autoPlay: !1,
					onload: function() {}
				}), soundManager.createSound({
			...
			function Zt() {
				soundManager.createSound({
					id: "musicintro",
					url: "Musics_intro_mastered2.mp3",
					autoLoad: !0,
					autoPlay: !1,
					onload: function() {
						Yn.musicloaded = !0
			...
			function rn() {
				function e() {
					o = sounds ? "on" : "off";
					var e = "";
					e += '<div id="moondialog" title="Going to the moon, hold on!" style="position:relative">', e += '<span id="moontext"><br/>Preparing to launch, please wait...</span><img src="loading.gif" class="toprightimg"/><div id="volumeicon3" class="small" style="position:absolute; left:5px;top:5px;"><a id="quickmute3" href="#"><span id="muteicon3" class="ui-icon ui-icon-volume-' + o + '"></span></a>(Sound recommended)</div></div>', e += '<div id="flyingrocket"></div>', $("#extracontainer").append(e), $("#moondialog").dialog({
				...
				function t() {
					switch (a) {
						case 0:
							o = sounds ? "on" : "off";
							var e = "";
							e += '<div id="moondialog2" title="Such Speech" style="position:relative">', e += '<span id="moontext2"></span><img src="doge_speech.png" style="position:absolute;right:5px;bottom:5px;"/><div id="volumeicon2" class="small" style="position:absolute; left:5px;top:5px;"><a id="quickmute2" href="#"><span id="muteicon2" class="ui-icon ui-icon-volume-' + o + '"></span></a>(Sound recommended)</div></div>', $("#extracontainer").append(e), $("#moondialog2").dialog({
								dialogClass: "no-close",
								show: {
									effect: "slide",
									duration: 2e3,
				...
				console.log("Levels.js: Loading level 2!"), Yn.loading_new_level = !0, $("#supermegacontainer").hide("fade", null, 1e3, e), ft(), At(), $("#BG").css("opacity", 0), $("#BG").css("background-image", 'url("bg001.jpg")'), $("#BG2").css("background-image", 'url("bg001.jpg")'), Qn = 1, soundManager.getSoundById("moonmusic").load();
				var o = "",
					a = 0,
					i = 0
			}
			...
			function on() {
				function e() {
					...
					var e = "";
					e += '<div id="moondialog" title="Going to Mars, hold on!" style="position:relative">', e += '<span id="moontext"><br/>Preparing to launch, please wait...</span><img src="nasadoge_tothemars.png" class="toprightimg" style="margin-top:10px;"/><div id="volumeicon3" class="small" style="position:absolute; left:5px;top:5px;"><a id="quickmute3" href="#"><span id="muteicon3" class="ui-icon ui-icon-volume-' + o + '"></span></a>(Sound recommended)</div></div>', e += '<div id="flyingrocket"></div>', $("#extracontainer").append(e), $("#moondialog").dialog({
						dialogClass: "no-close",
						show: {
							effect: "blind",
							duration: 1e3
				...
				function t() {
					switch (a) {
						case 0:
							o = sounds ? "on" : "off";
							var e = "";
							e += '<div id="moondialog2" title="Such Speech" style="position:relative">', e += '<span id="moontext2" style="float:right;"></span><img src="doge_speech.png" style="position:absolute;left:5px;bottom:5px;"/><div id="volumeicon2" class="small" style="position:absolute; left:5px;top:5px;"><a id="quickmute2" href="#"><span id="muteicon2" class="ui-icon ui-icon-volume-' + o + '"></span></a>(Sound recommended)</div></div>', $("#extracontainer").append(e), $("#moondialog2").dialog({
								dialogClass: "no-close",
								show: {
									effect: "slide",
									duration: 2e3,
				...
				console.log("Levels.js: Loading level 3!"), Yn.loading_new_level = !0, $("#supermegacontainer").hide("fade", null, 1e3, e), ft(), At(), $("#BG").css("background-image", 'url("bg103.jpg")'), $("#BG2").css("background-image", 'url("bg103.jpg")'), soundManager.getSoundById("marsmusic").load();
				var o = "",
					a = 0,
					i = 0
			}
			...
			var zn = $("#mined"),
				Jn = !1,
				Kn = !1,
				qn = (new Array("level1_17905a.png"), []);
			1 == Tn.level ? qn = new Array("bg1_2fb78b.jpg", "bg2.jpg", "bg3.jpg", "bg4.jpg", "bg5.jpg", "bg6.jpg", "bg7.jpg", "bg8.jpg", "bg9.jpg") : 2 == Tn.level ? qn = new Array("bg001.jpg", "bg002.jpg?2", "bg003.jpg") : 3 == Tn.level && (qn = new Array("bg101.jpg", "bg102.jpg", "bg103.jpg", "bg104.jpg", "bg105.jpg"));
			var Qn = 1,
				Xn = qn[0];
